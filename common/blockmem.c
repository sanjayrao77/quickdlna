...
#if 0
// this isn't needed for a lot of computers
// gcc can use "-fsanitize=alignment (to both compile and link)" to find alignment problems
#define ALIGN64
#endif
...
void *ptr;
ptr=alloc_blockmem(blockmem,size);
if (!ptr) return NULL;
memset(ptr,0,size);
return ptr;
}
